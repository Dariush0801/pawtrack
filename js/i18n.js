...
(function () {
  ...
  const translations = {
    en: {
      ...
      'report.searchLocPh': 'Search barangay, district, or landmark in Quezon City...',
      ...
      'report.finderPhone': 'Your Contact Phone *',
      'report.finderPhonePh': 'e.g. 0917 123 4567',
      'report.messageOptional': 'Message (optional)',
      'report.messagePh': 'Your pet is safe with me near the park entrance.',
      'report.selectPet': 'Select Pet *',
      'report.registered': 'Registered',
      'report.unregistered': 'Unregistered',
      'report.registeredPet': 'Registered',
      'report.unregisteredPet': 'Unregistered',
      'report.selectPetPh': 'Registered',
      'report.otherPet': 'Unregistered',
      ...
      'report.ownerPhonePh': 'e.g. 0917 555 3829',
      'report.circumstances': 'Describe Pet',
    ...
    fil: {
      ...
      'report.searchLocPh': 'Maghanap ng barangay, distrito, o landmark sa Quezon City...',
      ...
      'report.finderPhone': 'Iyong Cellphone *',
      'report.finderPhonePh': 'hal. 0917 123 4567',
      'report.messageOptional': 'Mensahe (opsyonal)',
      'report.messagePh': 'Ligtas ang alaga mo sa akin malapit sa park entrance.',
      'report.selectPet': 'Pumili ng Alaga *',
      'report.registered': 'Rehistrado',
      'report.unregistered': 'Hindi Rehistrado',
      'report.registeredPet': 'Rehistrado',
      'report.unregisteredPet': 'Hindi Rehistrado',
      'report.selectPetPh': 'Rehistrado',
      'report.otherPet': 'Hindi Rehistrado',
      ...
      'report.ownerPhonePh': 'hal. 0917 555 3829',
      'report.circumstances': 'Ilarawan ang Alaga (Describe Pet)',
